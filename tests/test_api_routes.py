...
EXPECTED_ROUTES = {
    ...
    ("/api/learned-rules/{owner:path}/{repo}", "POST"),
    ("/api/learned-rules/{owner:path}/{repo}/{rule_id}", "DELETE"),
    ("/api/learned-rules/{owner:path}/{repo}/{rule_id}", "GET"),
    ("/api/learned-rules/{owner:path}/{repo}/{rule_id}", "PUT"),
    ("/api/learned-rules/{owner:path}/{repo}/{rule_id}/active", "PATCH"),
    ("/api/learned-rules/{owner:path}/{repo}/{rule_id}/approve", "POST"),
    ("/api/learned-rules/{owner:path}/{repo}/{rule_id}/reject", "POST"),
    ...
    ("/api/repos/sync", "POST"),
    ("/api/repos/{owner:path}/{repo}", "GET"),
    ("/api/repos/{owner:path}/{repo}/blast-radius", "GET"),
    ("/api/repos/{owner:path}/{repo}/blast-radius.svg", "GET"),
    ("/api/repos/{owner:path}/{repo}/context", "GET"),
    ("/api/repos/{owner:path}/{repo}/context", "POST"),
    ("/api/repos/{owner:path}/{repo}/context/{context_id}", "DELETE"),
    ("/api/repos/{owner:path}/{repo}/context/{context_id}", "PUT"),
    ("/api/repos/{owner:path}/{repo}/dependencies", "GET"),
    ("/api/repos/{owner:path}/{repo}/external-refs", "GET"),
    ("/api/repos/{owner:path}/{repo}/files", "GET"),
    ("/api/repos/{owner:path}/{repo}/index", "DELETE"),
    ("/api/repos/{owner:path}/{repo}/index", "POST"),
    ("/api/repos/{owner:path}/{repo}/learned-rules", "GET"),
    ("/api/repos/{owner:path}/{repo}/packages", "GET"),
    ("/api/repos/{owner:path}/{repo}/reviews", "GET"),
    ("/api/repos/{owner:path}/{repo}/rules", "GET"),
    ("/api/repos/{owner:path}/{repo}/rules", "POST"),
    ("/api/repos/{owner:path}/{repo}/rules/{rule_id}", "DELETE"),
    ("/api/repos/{owner:path}/{repo}/rules/{rule_id}", "PUT"),
    ("/api/repos/{owner:path}/{repo}/vulnerabilities", "GET"),
